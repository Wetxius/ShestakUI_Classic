...
do
	...
	local url = IsClassicBuild() and "https://github.com/Wetxius/ShestakUI_Classic" or "https://github.com/Wetxius/ShestakUI"
...
do
	...
	width:SetPoint("TOPLEFT", distance, "BOTTOMLEFT", 0, -20)
...
do
	...
	raid_tools:SetPoint("TOPLEFT", max_camera_distance, "BOTTOMLEFT", 0, 0)
	...
	local function PositionGameMenuButton()
		...
		for button in GameMenuFrame.buttonPool:EnumerateActive() do
			...
			if lastIndex == anchorIndex and GameMenuFrame.ShestakUI then
				GameMenuFrame.ShestakUI:SetPoint("TOPLEFT", button, "BOTTOMLEFT", 0, -28)
