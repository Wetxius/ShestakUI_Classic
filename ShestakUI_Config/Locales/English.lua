...
L_GUI_UF_PLUGINS_DRUID_MANA_BAR = "Show mana bar for Druid in forms"
...
L_GUI_UF_RAID_PETS = "Show pets in raid (Only for heal layout)"
...
L.announcements_says_thanks = "Says thanks for some spells (resurrection, from the list)"
...
L.automation_invite_known_only = "Only allow auto invite from friends and guild members"
