...
L_GUI_PIXEL_FONT_CHAR = "Are you sure you want to reset your character's font settings to the pixel font style?"
L_GUI_PIXEL_FONT_ALL = "Are you sure you want to reset all of your font settings to the pixel font style?"
L_GUI_NORMAL_FONT_CHAR = "Are you sure you want to reset your character's font settings to the normal font style?"
L_GUI_NORMAL_FONT_ALL = "Are you sure you want to reset all of your font settings to the normal font style?"
...
L_GUI_GENERAL_BOTTOMLINES = "Show Bottom Panel Lines"
L.general_subheader_font_style = "Global font style (presets which overwrite individual font settings)"
...
L_GUI_UF_BAR_COLOR_HAPPINESS = "Color pet health bar by happiness"
...
L_GUI_UF_PLUGINS_POWER_SPARK = "Power spark on player frame"
...
L_GUI_TOOLTIP_SUBTEXT = "In this block, you can change the standard tips when mouseovering."
...
L_GUI_TOOLTIP_AVERAGE_LVL_DESC = "The average item level"
L_GUI_TOOLTIP_RAID_ICON = "Raid icon"
L_GUI_TOOLTIP_WHO_TARGETTING = "Display who is targeting the unit that is in your party/raid"
...
L_GUI_ANNOUNCEMENTS_SAYS_THANKS = "Says thanks for some spells (resurrection, from the list)"
...
L_GUI_ANNOUNCEMENTS_BAD_GEAR = "Check your bad gear in instance (fishing pole, from the list)"
...
L_GUI_AUTOMATION_CANCEL_BAD_BUFFS = "Auto cancel annoying holiday buffs (from the list)"
...
L.misc_color_picker = "Improved ColorPicker"
L.misc_color_picker_desc = "Add copy/paste buttons and digit text entry for Blizzard color picker frame"
L_GUI_MISC_ENCHANTMENT_SCROLL = "Enchantment scroll on TradeSkill frame"
L.misc_archaeology = "Archaeology tracker"
L.misc_archaeology_desc = "Archaeology tracker ('/arch' or right mouseover minimap button to show)"
