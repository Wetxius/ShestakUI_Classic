...
L_GUI_PIXEL_FONT_CHAR = "Вы уверены, что хотите сбросить настройки шрифта вашего персонажа на стиль пиксельного шрифта?"
L_GUI_PIXEL_FONT_ALL = "Вы уверены, что хотите сбросить все настройки шрифта на стиль пиксельного шрифта?"
L_GUI_NORMAL_FONT_CHAR = "Вы уверены, что хотите сбросить настройки шрифта вашего персонажа на обычный стиль шрифта?"
L_GUI_NORMAL_FONT_ALL = "Вы уверены, что хотите сбросить все настройки шрифта на обычный стиль шрифта?"
...
L_GUI_GENERAL_BOTTOMLINES = "Отображение нижних линий"
L.general_subheader_font_style = "Глобальный стиль шрифта (пресеты, которые перезаписывают отдельные настройки шрифтов)"
...
L_GUI_UF_PLAYER_NAME = "Отображение имени игрока и уровня"
L_GUI_UF_BAR_COLOR_HAPPINESS = "Цвет питомца по его настроению"
...
L_GUI_UF_SUBHEADER_PORTRAIT = "Портреты"
...
L_GUI_UF_PLUGINS_POWER_SPARK = "Индикация получение энергии"
...
L_GUI_UF_SOLO_MODE = "Всегда отображать рамку игрока без группы"
...
L.tooltip_vendor_price = "Цена продажи торговцу"
...
L_GUI_AUTOMATION_DISMOUNT_STAND = "Спешиваться/вставать при использовании заклинания"
...
L_GUI_AUTOMATION_CANCEL_BAD_BUFFS = "Снимать назойливые праздничные баффы (из списка)"
...
L.misc_max_camera_distance = "Увеличение максимальной дистанции камеры"
...
L_GUI_MISC_PROFESSION_TABS = "Вкладки ваших профессий у окна торговли/профессии"
L_GUI_MISC_HIDE_BG_SPAM = "Скрывать назойливые сообщения на полях боя"
L.misc_hide_bg_spam_desc = "Скрываются сообщения о захвате, потере точек на полях боя Арати и Гилнеас"
...
L.misc_sum_buyouts = "Отображать сумму ваших аукционов"
L.misc_sum_buyouts_desc = "Во вкладе лоты аукциона будет выводиться сумма ваших аукционов"
...
L.misc_color_picker = "Улучшенный подбор цвета"
L.misc_color_picker_desc = "В стандартное окно подбора цвета добавляются кнопки копировать/вставить, а так же поля для цифрового выставления цвета"
L_GUI_MISC_ENCHANTMENT_SCROLL = "Свиток наложения чар в окне профессии"
L.misc_archaeology = "Археологические артефакты"
L.misc_archaeology_desc = "Отслеживание раскопок артефактов (для показа нажмите скрытую кнопку справа от миникарты или введите '/arch')"
...
L.misc_armory_link = "Добавить пункт 'Оружейная'"
L.misc_armory_link_desc = "Добавить пункт 'Оружейная' в меню чата и цели (но при этом нельзя будет установить фокус через меню цели)"
