...
L_GUI_PIXEL_FONT_CHAR = "您确定要将角色的字体设置重置为像素字体样式吗?" -- Need review
L_GUI_PIXEL_FONT_ALL = "您确定要将所有字体设置重置为像素字体样式吗?" -- Need review
L_GUI_NORMAL_FONT_CHAR = "您确定要将角色的字体设置重置为正常字体样式吗?" -- Need review
L_GUI_NORMAL_FONT_ALL = "您确定要将所有字体设置重置为正常字体样式吗?" -- Need review
...
L_GUI_GENERAL_BOTTOMLINES = "显示底部面板线条" -- Need review
L.general_subheader_font_style = "全局字体样式(覆盖单个字体设置的预置)" -- Need review
...
L_GUI_UF_PLAYER_NAME = "显示玩家姓名和等级" -- Needs review
