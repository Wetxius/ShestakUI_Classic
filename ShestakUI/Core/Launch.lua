...
local function InstallUI()
	...
	if C.chat.enable == true and not (C_AddOns.IsAddOnLoaded("Prat-3.0") or C_AddOns.IsAddOnLoaded("Chatter")) then
		...
		if T.Classic then
			SetCVar("chatClassColorOverride", 0)
			SetCVar("colorChatNamesByClass", 1)
			SetChatColorNameByClass("SAY", true)
			SetChatColorNameByClass("EMOTE", true)
			SetChatColorNameByClass("YELL", true)
			SetChatColorNameByClass("GUILD", true)
			SetChatColorNameByClass("OFFICER", true)
			SetChatColorNameByClass("GUILD_ACHIEVEMENT", true)
			SetChatColorNameByClass("ACHIEVEMENT", true)
			SetChatColorNameByClass("WHISPER", true)
			SetChatColorNameByClass("PARTY", true)
			SetChatColorNameByClass("PARTY_LEADER", true)
			SetChatColorNameByClass("RAID", true)
			SetChatColorNameByClass("RAID_LEADER", true)
			SetChatColorNameByClass("RAID_WARNING", true)
			SetChatColorNameByClass("INSTANCE_CHAT", true)
			SetChatColorNameByClass("INSTANCE_CHAT_LEADER", true)
			SetChatColorNameByClass("CHANNEL1", true)
			SetChatColorNameByClass("CHANNEL2", true)
			SetChatColorNameByClass("CHANNEL3", true)
			SetChatColorNameByClass("CHANNEL4", true)
			SetChatColorNameByClass("CHANNEL5", true)
		else
