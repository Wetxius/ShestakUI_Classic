...
L_MISC_UI_OUTDATED_CLASSIC = "Your version of ShestakUI is out of date. You can download the latest version from https://github.com/Wetxius/ShestakUI_Classic"
