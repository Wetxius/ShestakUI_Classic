...
L_MISC_UI_OUTDATED = "ShestakUI 版本已过期，请至 https://github.com/Shestak/ShestakUI 下载最新版。"
L_MISC_UI_OUTDATED_CLASSIC = "ShestakUI 版本已过期，请至 https://github.com/EsreverWoW/ShestakUI_Classic 下载最新版。"
