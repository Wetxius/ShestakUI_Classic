...
L_MISC_UI_OUTDATED_CLASSIC = "Deine Version von ShestakUI ist veraltet. Du kannst die aktuelle Version von https://github.com/Wetxius/ShestakUI_Classic laden"
